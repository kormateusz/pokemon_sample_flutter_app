...
// ignore: unused_element
  _Loaded loaded(List<Pokemon> value) {
    return _Loaded(
      value,
    );
  }
...
mixin _$PokedexState {
  ...
  TResult when<TResult extends Object>({
    ...
    @required TResult loaded(List<Pokemon> value),
    @required TResult error(String errorMessage),
  });
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object>({
    TResult loading(),
    TResult loaded(List<Pokemon> value),
...
class _$_Loading with DiagnosticableTreeMixin implements _Loading {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties..add(DiagnosticsProperty('type', 'PokedexState.loading'));
  }
...
class __$LoadedCopyWithImpl<$Res> extends _$PokedexStateCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    return _then(_Loaded(
      value == freezed ? _value.value : value as List<Pokemon>,
    ));
  }
}
...
class _$_Loaded with DiagnosticableTreeMixin implements _Loaded {
  const _$_Loaded(this.value) : assert(value != null);

  @override
  final List<Pokemon> value;

  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'PokedexState.loaded(value: $value)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'PokedexState.loaded'))
...
abstract class _Loaded implements PokedexState {
  const factory _Loaded(List<Pokemon> value) = _$_Loaded;

  List<Pokemon> get value;
  @JsonKey(ignore: true)
  _$LoadedCopyWith<_Loaded> get copyWith;
}
...
class _$_Error with DiagnosticableTreeMixin implements _Error {
  ...
  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'PokedexState.error(errorMessage: $errorMessage)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'PokedexState.error'))
